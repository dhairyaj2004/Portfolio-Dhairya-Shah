  ...
  return (
    <div className="text-slate-200 justify-between px-4 py-3 text-xl bg-slate-900 min-h-screen flex flex-col gap-5">
      ...
      <div id="My Projects">
        ...
        <div id="Projects-Container" className="grid gap-4 xl:grid-cols-4 lg:grid-cols-3 lg:justify-around md:grid-cols-2 md:justify-center sm:grid-cols-1 sm:align-center">
